...
<html lang="en">
  ...
  <div class="l-navbar" id="nav-bar">
    ...
    @method("put")
      ...
      <input type="text" class="form-control mb-3" id="description" name="description" value="{{old('description') ?? $product->description}}">
      ...
      <input onkeyup="getTotal();" type="number"class="form-control m-3" id="productPriceInput"placeholder="PriceBeforeDiscount"
      name="PriceBeforeDiscount"   value="{{old('PriceBeforeDiscount') ?? $product->PriceBeforeDiscount}}">
    ...
    <input onkeyup="getTotal();" type="number"class="form-control m-3" id="productPriceInput"placeholder="PriceAfterDiscount"
    name="PriceAfterDiscount"   value="{{old('PriceAfterDiscount') ?? $product->PriceAfterDiscount}}">
      @error("PriceAfterDiscount")
        <p class="text-danger"> {{$message}} </p>
                @enderror
                <input onkeyup="getTotal();" type="number"class="form-control m-3" id="productPriceInput"quantity="quantity"
