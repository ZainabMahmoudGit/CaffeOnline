...
<svg class="logo2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="300" height="300" viewbox="0 0 640 480" xml:space="preserve">
  ...
  @csrf
        <div class="name">
            ...
            <div class="sec-2">
                <input id="name" type="text" placeholder="Enter Your Name"   class="form_input @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
...
@enderror
        ...
        <div class="password">
            ...
            <div class="sec-2">
                <input id="Confirm Password" type="password" placeholder="Enter Confirm Password" class="pas form_input"   name="password_confirmation" required autocomplete="new-password">
...
@enderror
    ...
    <button class="btn custom-btn smoothscroll me-2 mb-2"> {{ __('Create Account') }} </button>
</div>
